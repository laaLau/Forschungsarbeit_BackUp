...
\subsubsection{Frühe Pläne zur Urbanen Landwirtschaft}
...
\subsubsection{Auszug der urbanen Landwirtschaft am Beispiel Deutschland}
...
\subsubsection{Urbane Landwirtschaft aus globaler Perspektive}
...
\subsubsection{Urbane Landwirtschaft bis heute}
...
\begin{displayquote}
"recent advantages in greenhouse technologies such as hydroponics, aeroponics,and aquaponics have provided a promising future to the vertical farm concept."\footnotetext[S.1]{Al-Kodmany2018TheCity}\end{displayquote}
...
\begin{figure}[h]
\centering
\includegraphics[width=8cm]{image_folder/moglicheVorteileVonVF.png}
\caption{mogliche Vorteile von Vertical Farming Systemen im Überblick}
\label{fig:vorteileVF}
\end{figure}

Im Vergleich zu traditionellen und landbasierten Anbaumethoden, die für Traktoren, Pflüge etc. fossile auf fossile Energien angewiesen sind\footnote[S.27]{Als Beispiel: In Nordamerika wird 20\% der fossilen Energie von der Landwirtschaft verbraucht}{Al-Kodmany2018TheCity[82,83]}, kann VF den Bedarf an fossilen Rohstoffen senken.
...
\end{itemize}
 ...
 \begin{itemize}
     ...
     \item "erhöhter Arbeits‐ und Koordinationsaufwand aufgrund der Kleinteiligkeit der Verteilung auf verschiedene Stadtbezirke(GALK 2006). "Vielfach ist erst eine Schlaggröße von vier bis fünf Hektar für den Landwirt wirtschaftlich interessant (SENATSVERWALTUNG FÜR STADTENT‐ WICKLUNG 2010)." (Quelle: Urbane Landwirtschaft und Green Production als Teil eines nachhaltigen Landmanagements)
 \end{itemize}
