...
\usepackage[default,osfigures,scale=1]{opensans}  %% Option 'sfdefault' only if the base font of the document is to be sans serif
% Verlinke Zitate
...
% Beispiele nennen: Prinzessinnengarten in Berlin oder 
...
% ein zwei Motive nennen 

Dabei hat Landwirtschaft eine lange Tradition der menschlichen Lebensmittelversorgung.


%Einerseits müssen immer mehr Menschen auf engem Raum mit Lebensmitteln versorgt werden. Andererseits ist mit dem Ausbau von Siedlungs- und Verkehrsflächen ein stetiger Verlust an produktiven landwirtschaftlichen Flächen verbunden. 
...
%Mekis Nachhaltigkeitsbewertung zu Aquaponik
