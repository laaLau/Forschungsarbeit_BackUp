...
\end{figure}
\footnotetext[S.12]{Berges2004UrbaneStadt}
...
\label{fig:ul_typologie}
\end{figure}
\footnotetext[]{Eigene Zeichnung, entstanden aus dem Vorbild von Carlos Tobisch, Oasen im Beton (S.26, Abb. 7)}
...
3. Großflächiger Anbau über mehrere Etagen mit dem unternehmerischen Gedanken.

\begin{figure}[h]
\centering
\includegraphics[width=12cm]{image_folder/moglicheEinteilungena_s32.png}}
...
Nur etwa 7\% der Nahrungsmittel die dort konsumiert werden, werden auch tatsächlich in Singapur produziert. Nur 250 Acker auf der Insel widmen sich dem Anbau von Nahrungsmitteln. Der weitere Lebensmittelbedarf wird über Import gelöst. Aus den oben genannten Gründen hat Singapur viel Mühe in die Forschung des Lebensmittelanbaus mittels Vertical Farming gesteckt. 
